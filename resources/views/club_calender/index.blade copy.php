                ...
                @foreach($schedule8 as $value)
                    ...
                    if(in_array("8:00AM",$time)){
                            ...
                            if(is_null($club_calender)){
                                $route = route('clubcalender.add',['date' => $value->id, 'time' => "8:00AM"]);
                                $name = "SCHEDULE";
                            }
                            else{
            ...
            ?>
                @foreach($schedule8 as $value)
                    ...
                    if(in_array("9:00AM",$time)){
                            ...
                            if(is_null($club_calender)){
                                $route = route('clubcalender.add',['date' => $value->id, 'time' => "9:00AM"]);
                                $name = "SCHEDULE";
                            }
                            else{
                                if(is_null($club_calender->schedule)){
            ...
            ?>
                @foreach($schedule8 as $value)
                    ...
                    if(in_array("10:00AM",$time)){
                            ...
                            if(is_null($club_calender)){
                                $route = route('clubcalender.add',['date' => $value->id, 'time' => "10:00AM"]);
                                $name = "SCHEDULE";
                            }else{
                                $route = route('clubcalender.edit',$club_calender->id);
                                $name = "SCHEDULED";
            ...
            ?>
                @foreach($schedule8 as $value)
                    ...
                    if(in_array("11:00AM",$time)){
                            ...
                            if(is_null($club_calender)){
                                $route = route('clubcalender.add',['date' => $value->id, 'time' => "11:00AM"]);
                                $name = "SCHEDULE";
                            }
                            else{
                                if(is_null($club_calender->schedule)){
            ...
            ?>
                @foreach($schedule8 as $value)
                    ...
                    if(in_array("12:00PM",$time)){
                            ...
                            if(is_null($club_calender)){
                                $route = route('clubcalender.add',['date' => $value->id, 'time' => "12:00PM"]);
                                $name = "SCHEDULE";
                            }
                            else{
                                if(is_null($club_calender->schedule)){
            ...
            ?>
                @foreach($schedule8 as $value)
                    ...
                    if(in_array("1:00PM",$time)){
                            ...
                            if(is_null($club_calender)){
                                $route = route('clubcalender.add',['date' => $value->id, 'time' => "1:00PM"]);
                                $name = "SCHEDULE";
                            }
                            else{
                                if(is_null($club_calender->schedule)){
            ...
            ?>
                @foreach($schedule8 as $value)
                    ...
                    if(in_array("2:00PM",$time)){
                            ...
                            if(is_null($club_calender)){
                                $route = route('clubcalender.add',['date' => $value->id, 'time' => "2:00PM"]);
                                $name = "SCHEDULE";
                            }
                            else{
                                if(is_null($club_calender->schedule)){
        ...
        <div class="events col-12 col-lg-11 col-md-10 col-sm-10">
            ...
            ?>
                @foreach($schedule8 as $value)
                    ...
                    if(in_array("3:00PM",$time)){
                            $roster = DB::table('athlete')->where('user_id',$value->user_id)->first();
                            
                            $club_calender = DB::table('club_calender')->where('date',$value->date)->where('time',"3:00PM")->where('club_id',$value->club_id)->where('user_id',Auth::user()->id)->first();
                            if(is_null($club_calender)){
                                $route = route('clubcalender.add',['date' => $value->id, 'time' => "3:00PM"]);
                                $name = "SCHEDULE";
                            }
                            else{
                                if(is_null($club_calender->schedule)){
            ...
            ?>
                @foreach($schedule8 as $value)
                    ...
                    if(in_array("4:00PM",$time)){
                            ...
                            if(is_null($club_calender)){
                                $route = route('clubcalender.add',['date' => $value->id, 'time' => "4:00PM"]);
                                $name = "SCHEDULE";
                            }
                            else{
                                if(is_null($club_calender->schedule)){
            ...
            ?>
                @foreach($schedule8 as $value)
                    ...
                    if(in_array("5:00PM",$time)){
                            ...
                            if(is_null($club_calender)){
                                $route = route('clubcalender.add',['date' => $value->id, 'time' => "5:00PM"]);
                                $name = "SCHEDULE";
                            }
                            else{
                                if(is_null($club_calender->schedule)){
            ...
            ?>
                @foreach($schedule8 as $value)
                    ...
                    if(in_array("6:00PM",$time)){
                            ...
                            if(is_null($club_calender)){
                                $route = route('clubcalender.add',['date' => $value->id, 'time' => "6:00PM"]);
                                $name = "SCHEDULE";
                            }
                            else{
                                if(is_null($club_calender->schedule)){
            ...
            ?>
                @foreach($schedule8 as $value)
                    ...
                    if(in_array("7:00PM",$time)){
                            ...
                            if(is_null($club_calender)){
                                $route = route('clubcalender.add',['date' => $value->id, 'time' => "7:00PM"]);
                                $name = "SCHEDULE";
                            }
                            else{
                                if(is_null($club_calender->schedule)){
