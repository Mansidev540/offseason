...
<div class="right-panel p-4">
    ...
    <form id="member" method="POST" action="{{ route('clubcalender.save') }}" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-4 ">
                <div class="pt-4">
                    <div class="d-flex flex-column">
                        ...
                        <!-- Card modal -->
                        <div class="modal fade" id="card_modal" tabindex="-1" role="dialog" aria-hidden="true" style="margin-left: -6rem;margin-top: 6%;">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content pt-1" style="width: 50rem;height: auto;">

                                    <div class="modal-body card_details">
                                        <div class="d-flex pb-4">
                                            <div class="flex-grow-1 d-flex align-items-center">
                                                <h2 class="text-uppercase me-4 mb-0">Card Details</h2>
                                            </div>
                                        </div>
                                        <div>
                                            <label class="col-form-label">Name On Card</label>
                                            <input type="text" class="form-control mb-2" id="card_name" name="card_name">
                                        </div>
                                        <div>
                                            <label class="col-form-label">Card Number</label>
                                            <input type="text" class="form-control mb-2" id="card_number" name="card_number">
                                        </div>
                                        <div>
                                            <label class="col-form-label">Expiry Date</label>
                                            <input type="text" class="form-control mb-2" id="card_date" name="card_date">
                                        </div>
                                        <div>
                                            <label class="col-form-label">CVV</label>
                                            <input type="text" class="form-control mb-2" id="card_cvv" name="card_cvv">
                                        </div>
                                        <div class="d-flex justify-content-center pt-4">
                                            <a href="javascript:void(0)" class="scheduled_cancle me-3" data-dismiss="modal">Cancel</a>
                                            <a href="javascript:void(0)" class="btn btn-primary member" data-dismiss="modal" id="submit_button">Submit</a>
                                        </div>
                        ...
                        <div class="club-info d-flex mb-5 member_div">
                            ...
                            <div class="club-dt d-flex align-items-center">
                                <a class="Trainer_btn" href="javascript:void(0)" data-toggle="modal" data-target="#delete-msg">Choose Trainee</a>
                            </div>
                        </div>
                        ...
                        <div class="club-info d-flex mb-5 tariner_div">
                            ...
                            <div class="club-dt d-flex align-items-center">
                                <a class="Trainer_btn" href="javascript:void(0)" data-toggle="modal" data-target="#choose_trainee">Choose Trainer</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal fade" id="delete-msg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="margin-left: -6rem;margin-top: 6%;">
                <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="table-responsive pt-4 mb-5">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            <input class="p-0 m-0" type="radio" name="member_select" id="member_{{$member_value->id}}" value="{{$member_value->id}}">
                                        </td>
                                        <td>
                                            <img class="rounded-circle" src="{{asset("uploads/$member_value->image")}}" alt="" width="50px">&nbsp;&nbsp;&nbsp;{{$member_value->name}}
                                        </td>
            ...
            <div class="modal fade" id="choose_trainee" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="margin-left: -6rem;margin-top: 6%;">
                <div class="modal-dialog" role="document">
                    <div class="modal-content" style="width: 50rem;height: auto;">
                        <button type="button" class="close border-0" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="table-responsive pt-4 mb-5">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            <input class="p-0 m-0" type="radio" name="athlete_select" id="athlete_select_{{$athlete->id}}" value="{{$athlete->id}}" data="<?php if (is_null($schedule8)) {
                                                                                                                                                                                echo 0;
                                                                                                                                                                            } else {
                                                                                                                                                                                echo $schedule8->booking_rate;
                                                                                                                                                                            } ?>">
                                        </td>
                                        <td>
                                            <a href="#"><img class="rounded-circle" src="{{asset("uploads/$athlete->image")}}" alt="" width="50px"></a>&nbsp;&nbsp;&nbsp;<a href="#" class="link">{{$athlete->athlete_name}}</a>
                                        </td>
            ...
            <div class="col-12 d-flex justify-content-end">
                ...
                <button type="submit" class="check_out ms-3" onclick="" style="">Check Out</button>
            </div>
            ...
            success: function(res) {
                ...
                if (res) {
                    ...
                    $.each(res.member, function(key, value) {
                        ...
                        $('#card_name').val(name);
                        $('#card_number').val(value.card_no);
                        $('#card_date').val(value.valid_date);
