...
<div class="right-panel p-4">
    <div class="d-flex pb-4">
        ...
        <a href="javascript:void(0)" data-toggle="modal" data-target="#id_model" class="btn button btn3 add-btn">Add Club</a>
...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-content ">
        ...
        <h2 class="text-center">New Club</h2>

        <div class="modal-body">

            <p class="text-center">Send an email invite to add a new club.</p>
